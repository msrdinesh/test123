...
class HomeScreen extends State<HomePage> {
  ...
  Widget showLocation() {
    return Container(height: 40, width: 10000, child: Align(alignment: Alignment.centerLeft, child: Padding(padding: EdgetInsets.all(5), child: Text("Location will come here", textAlign: TextAlign.left))), color: Color(0xff90ee90));
  }
