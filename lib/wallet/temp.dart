            ...
            child: ConstrainedBox(
              ...
              child: Column(
                ...
                children: <Widget>[
                      ...
                      children: <Widget>[
                        Center(
                          child: Container(
                            ...
                            decoration: BoxDecoration(color: Colors.white, borderRadius: BorderRadius.all(Radius.circular(45)), border: Border.all(color: yellow, width: 1.5)),
                            child: openOptions.value < 300
                                ...
                                : Align(
                                    ...
                                    child: Row(
                                      mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                      children: <Widget>[
                                        InkWell(onTap: () => Navigator.of(context).push(MaterialPageRoute(builder: (_) => SendPage())), child: Text('Pay')),
                                        InkWell(onTap: () => Navigator.of(context).push(MaterialPageRoute(builder: (_) => RequestPage())), child: Text('Request')),
                                      ],
                                    ),
                                  ),
                          ),
                        ...
                        Center(
                            child: CustomPaint(
                                ...
                                child: GestureDetector(
                                  ...
                                  child: Container(width: 110, height: 110, child: Center(child: Text('\$', style: TextStyle(color: Color.fromRGBO(255, 255, 255, 0.5), fontSize: 32)))),
                                )))
                      ],
                    ),
                  ),
                  Padding(
                    padding: const EdgeInsets.all(16.0),
                    child: Text(openOptions.value > 0 ? '' : 'Tap to pay / request', style: TextStyle(fontSize: 10)),
                  ),
                  Padding(
                    ...
                    child: users.length == 0
                        ...
                        : Container(
                            ...
                            child: ListView(scrollDirection: Axis.horizontal, children: [
                              ...
                              ...users
                                  .map((user) => InkWell(
                                        onTap: () => Navigator.of(context).push(MaterialPageRoute(builder: (_) => RequestAmountPage(user))),
                                        child: Container(
                                            width: 100,
                                            height: 200,
                        ...
                        itemBuilder: (_, index) => Container(
                          ...
                          child: Column(
                            ...
                            children: <Widget>[
                              ...
                              Padding(
                                padding: const EdgeInsets.symmetric(vertical: 8.0),
                                child: Text('Dicount Voucher', style: TextStyle(color: Colors.grey, fontSize: 16.0, fontWeight: FontWeight.bold)),
                              ),
                              Padding(
                                padding: const EdgeInsets.symmetric(vertical: 8.0),
...
class YellowDollarButton extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    canvas.drawCircle(Offset(width / 2, height / 2), height / 2, Paint()..color = Color.fromRGBO(253, 184, 70, 0.2));
    canvas.drawCircle(Offset(width / 2, height / 2), height / 2 - 4, Paint()..color = Color.fromRGBO(253, 184, 70, 0.5));
    canvas.drawCircle(Offset(width / 2, height / 2), height / 2 - 12, Paint()..color = Color.fromRGBO(253, 184, 70, 1));
    canvas.drawCircle(Offset(width / 2, height / 2), height / 2 - 16, Paint()..color = Color.fromRGBO(255, 255, 255, 0.1));
  }
