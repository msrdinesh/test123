...
//"https://mobileapis.feednext.in/cornext/v" + appVersion.toString() + "/";
    "https://FeedNext-MobileAPIS-ELB-2044358733.ap-south-1.elb.amazonaws.com/cornext/v" + appVersion.toString() + "/";
...
final String refreshTokenUrl = urlPrefixWithOutAppVersion + 'oauth/token?grant_type=refresh_token&refresh_token=';
...
final String forgotPasswordGenerateOtpUrl = urlPrefix + 'forgotpasswordgenerateotp';
final String forgotPasswordValidateOtpUrl = urlPrefix + 'validateforgotpasswordotp';
final String newPasswordUrl = urlPrefix + 'updateuserpassword';
final String registrationValidateOtpUrl = '$urlPrefix' + 'registration/validateotps';
...
final String productListAfterLoginUrl = '$urlPrefix' + 'getproductlistafterlogin';
...
final String registrationDiscountDetails = "$urlPrefix" + "getRegistartiondiscountdetails";
...
final String orderConfirmationurl = "$urlPrefix" + "getorderconfirmationdetails";
...
final String deleteOrderSubscriptionInfo = "$urlPrefix" + 'deactivatesubscription/';
...
final String changeSubscriptionAddressUrl = "$urlPrefix" + 'updatesubscribedorderaddress';
final String checkAddressLinkedWithSubscriptionsurl = '$urlPrefix' + 'issubscribedaddress/';
...
final String isOrderLinkedWithSubscriptionUrl = '$urlPrefix' + 'subscribedorderornot';
final String getCategoriesAndSubCategoriesUrl = "$urlPrefix" + "getallcategories";
final String prepaidSubscriptionListUrl = '$urlPrefix' + 'getprepaidsubscribedorders';
final String postpaidSubscriptionListurl = '$urlPrefix' + 'getpostpaidsubscribedorders';
final String getIndividualPrepaidSubscriptionData = '$urlPrefix' + "getsubscriptiondrilldowndata/";
final String getSizesOfCurrentProductUrl = '$urlPrefix' + 'getproductsizes';
final String checkPinCodeAvailableForProduct = '$urlPrefix' + 'checkAvailability';
final String removeProductsFromErpDataTableUrl = '$urlPrefix' + 'deletequantity/';
final String checkPinCodeAvailableForCartProductsUrl = '$urlPrefix' + 'getAvailability/';
...
final String checkPincodeIsLinkedWithActiveOrdersUrl = '$urlPrefix' + 'getcurrentordershippingadresscount';
final String getLatestAppVersionUrl = urlPrefixWithOutAppVersion + 'getappversion';
...
final String razorPayGetPaymentDetailsUrl = 'https://api.razorpay.com/v1/payments/';
final String getRazorPayKeyUrl = '$urlPrefixWithOutAppVersion' + 'getrazorpaycredentials';
